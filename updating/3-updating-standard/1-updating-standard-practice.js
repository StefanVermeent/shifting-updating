...
var updating_standard_feedback = {
  type: jsPsychHtmlButtonResponse,
  stimulus: function() {
    var squares  = jsPsych.data.get().last(1).values()[0].response.Q0;
    var triangles = jsPsych.data.get().last(1).values()[0].response.Q1;
    var circles   = jsPsych.data.get().last(1).values()[0].response.Q2;
