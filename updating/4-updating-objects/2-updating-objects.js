  ...
  timeline: [
    {
      ...
      choices: ['Start'],
      data: function(){return jsPsych.timelineVariable('data1')},
    },
    {
      type: jsPsychAnimation,
      stimuli: function(){return jsPsych.timelineVariable('sequence')},
      frame_time: 1000,
      frame_isi: 500,
      choices: -1,
      data: function(){return jsPsych.timelineVariable('data2')},
    },
    {
      type: jsPsychSurveyLikert,
      data: function(){return jsPsych.timelineVariable('data3')},
      button_label: 'Next',
      questions: [
