...
var updating_ecological_feedback = {
  type: jsPsychHtmlButtonResponse,
  stimulus: function() {
    var bills = jsPsych.data.get().last(1).values()[0].response.Q0;
    var buses = jsPsych.data.get().last(1).values()[0].response.Q1;
    var faces = jsPsych.data.get().last(1).values()[0].response.Q2;
